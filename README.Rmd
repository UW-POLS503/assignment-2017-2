...
5. Calculate the predicted value and confidence interval for the PLU with the median value of `outratiodiff`, `popratiodiff`, and `oldratiodiff` 
  in each year and PLU Type for these models.
...
7. Repeat the previous step but use a **prediction interval** instead of a confidence interval. What is the difference between the confidence and prediction intervals.
